...
# Default the Fly app name to {repo_owner}-{repo_name}-pr-{number}
app="${INPUT_NAME:-$REPO_OWNER-$REPO_NAME-pr-$PR_NUMBER}"
...
if [ -n "$INPUT_POSTGRES" ]; then
  flyctl postgres attach "$INPUT_POSTGRES" -y || true
fi
